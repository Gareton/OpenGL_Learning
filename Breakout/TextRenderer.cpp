...
{
	TextShader = ResourceManager::LoadShader("textShader.vert", "textShader.frag", nullptr, "text");;

	glm::mat4 projection = glm::ortho(0.0f,(float) width, (float) height, 0.0f, 0.0f, 1.0f);

	TextShader.SetMatrix4("projection", projection, GL_TRUE);
...
{
	this->TextShader.Use();
	this->TextShader.SetVector4f("color", color);
